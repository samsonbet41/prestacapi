...
$pageTitle = $lang->get('site_name') . ' - ' . $lang->get('tagline');
$pageDescription = $lang->get('hero_subtitle');
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="canonical" href="<?php echo $lang->getCanonicalUrl(); ?>">
    
    <?php echo $seo->generateOpenGraphTags([
        'title' => $pageTitle,
        'description' => $pageDescription,
        'url' => $lang->getCanonicalUrl(),
        'image' => $lang->getBaseUrl() . '/images/og-prestacapi.jpg'
    ]); ?>
    
    <?php echo $seo->generateTwitterCard([
        'title' => $pageTitle,
        'description' => $pageDescription,
        'image' => $lang->getBaseUrl() . '/images/og-prestacapi.jpg'
    ]); ?>
